...
const animes = [
	...
	{
		name: 'Prime Gaming and Riot Games Run it Back',
		image:
	...
	{
		name: 'Anh Trai Tôi Là Khủng Long',
		image:
							...
							<div key={i} className="relative transition duration-500 ease-in-out hover:scale-105">
								...
								<Link href="#">
									...
									<div className="absolute bottom-0 w-full bg-gradient-to-t from-black to-transparent px-6 py-6 rounded-b">
										<p className="text-white font-bold text-sm md:text-lg">{e.name}</p>
									</div>
								</Link>
							</div>
						))}
