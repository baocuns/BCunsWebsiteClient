...
const Crawls = (props: Props) => {
	...
	return (
		<>
			<Head>
				<title>Thu Thập Dữ Liệu | BCuns</title>
				<SEO
			...
			<main>
				<div className="px-4 sm:px-8 md:px-12 lg:px-16 py-4 md:py-6">
					<div className="flex items-center gap-4 mb-4">
						...
						<h2 className="text-2xl font-bold tracking-tight text-white">Crawls Data</h2>
					</div>
					{/* crawls */}
				...
				<OpstionAddMovie
					...
					listMovieCrawls={dataCrawls}
					listMovieServer={dataServer}
				/>
